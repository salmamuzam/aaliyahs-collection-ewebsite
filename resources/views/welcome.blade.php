...
<body>
    ...
    <section class="px-3 py-5 bg-neutral-100 lg:py-10">
        <div class="grid items-center gap-5 lg:grid-cols-2 justify-items-center">
            <div class="flex flex-col items-center justify-center order-2 lg:order-1">
                ...
                <button
                    class="px-5 py-2 mt-10 text-lg text-white bg-teal-900 md:text-2xl hover:bg-zinc-800 rounded-xl">Shop
                    Now</button>
            </div>
            <div class="order-1 lg:order-2">
                <img class="h-80 w-80 object-cover lg:w-[500px] lg:h-[500px] rounded-xl" src="images/abaya_banner.webp"
                    alt="">
            </div>
        </div>
    </section>
    <div class="p-4 bg-[#F3EDE8]">
        <div class="max-w-screen-xl mx-auto">
            <div class="px-6 py-8 rounded-2xl bg-gradient-to-r sm:py-14">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <p class="text-lg text-slate-600">At Aaliyah's Collection, we believe the muslims deserve the very
                        best. As a premium store for women, we bring together a carefully considered range of clothing
                        collections to support muslim women through every stage with modesty, elegance and care.</p>
                    <button
                        class="px-6 py-3 mt-8 text-base font-medium text-white transition bg-teal-600 rounded-full cursor-pointer hover:bg-teal-700">
                        Shop Now
                    </button>
                </div>
            </div>
    ...
    <div class="bg-gray-100 rounded-[20px] sm:p-8 p-6">
        <div class="max-w-screen-xl mx-auto">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <div
                    class="shadow-sm bg-white p-1.5 rounded-md overflow-hidden cursor-pointer relative hover:shadow-md">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-xl:gap-4">
                ...
                <div class="p-3 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <a href="javascript:void(0)" class="block">
                        ...
                        <p class="text-slate-600 text-[13px] mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit.</p>
                    </a>
    ...
    <section class="px-20 pt-6 text-gray-700 bg-[#F3EDE8] body-font">
