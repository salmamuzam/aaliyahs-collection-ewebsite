<div class="min-h-screen flex items-center justify-center bg-blue-400">
  ...
  <div class="bg-white p-16 rounded shadow-2xl w-2/3">
    ...
    <h2 class="text-3xl font-bold mb-10 text-gray-800">Add a New Product</h2>
    ...
    <form class="space-y-5">
      ...
      <div>
        <label class="block mb-1 font-bold text-gray-500">Slug</label>
        <input type="text" class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
      </div>

      <div>
        <label class="block mb-1 font-bold text-gray-500">Description</label>
        <input type="textarea" class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
      </div>
